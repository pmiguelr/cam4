! function(t) {
    ...
    return t.extend(e.prototype, {
        ...
        support: function(e) {
            var i = {
                ...
                n = function() {
                    var t, s, n = i.transition;
                    document.body.appendChild(e), n && (t = n.name.slice(0, -9) + "ransform", void 0 !== e.style[t] && (e.style[t] = "translateZ(0)", s = window.getComputedStyle(e).getPropertyValue(n.prefix + "transform"), i.transform = {
                        prefix: n.prefix,
                        name: t,
                        translate: !0,
                        translateZ: !!s && "none" !== s
        ...
        animate: function(t, e, i) {
            ...
            var s = this,
                ...
                o = window.setInterval(function() {
                    ...
                    return a > i ? (s.slidesContainer[0].style.left = e + "px", s.ontransitionend(), void window.clearInterval(o)) : void(s.slidesContainer[0].style.left = (e - t) * (Math.floor(a / i * 100) / 100) + t + "px")
                }, 4)
        },
                ...
                d = function(e) {
                    if (!s) {
                        if (e = {
                                type: e.type,
                                target: n
                            }, !n.parentNode) return a.setTimeout(d, [e]);
                        s = !0, t(l).off("load error", d), h && "load" === e.type && (n.setAttribute("data-original", r), n.style.backgroundSize = h), i(e)
                    }
                };
    ...
    function(t) {
        ...
        var s = e.prototype.initSlides,
            n = e.prototype.addSlide,
            o = e.prototype.resetSlides,
            a = e.prototype.handleClick,
        ...
        return t.extend(e.prototype, {
            createIndicator: function(e) {
                ...
                return this.options.thumbnailIndicators && (a && (i = this.getItemProperty(e, a)), void 0 === i && (s = e.getElementsByTagName && t(e).find("img")[0], s && (i = s.getAttribute("data-original"))), i && n.setAttribute("data-original", i)), o && (n.title = o), n
            },
            addIndicator: function(t) {
                if (this.indicatorContainer.length) {
                    var e = this.createIndicator(this.list[t]);
                    e.setAttribute("data-index", t), this.indicatorContainer[0].appendChild(e), this.indicators.push(e), e.className = "lazy " + e.className
                }
            },
            ...
            inViewport: function(t) {
                ...
                return e.top >= 0 && e.left >= 0 && e.bottom <= (window.innerHeight || document.documentElement.clientHeight) && e.right <= (window.innerWidth || document.documentElement.clientWidth) + i
            },
            throttle: function(t, e, i) {
                ...
                i || (i = {});
                var r = function() {
                    l = i.leading === !1 ? 0 : Date.now(), a = null, o = t.apply(s, n), s = n = null
                };
                return function() {
                    var h = Date.now();
                    l || i.leading !== !1 || (l = h);
                    var d = e - (h - l);
                    return s = this, n = arguments, 0 >= d ? (clearTimeout(a), a = null, l = h, o = t.apply(s, n), s = n = null) : a || i.trailing === !1 || (a = setTimeout(r, d)), o
                }
            },
            initLazyLoad: function(t) {
                var e = document.getElementsByClassName("indicator")[0],
                    s = document.getElementsByClassName("lazy"),
                    n = t.throttle(function(e) {
                        for (i = 0; i < s.length; i++) t.inViewport(s[i]) && s[i].getAttribute("data-original") && (s[i].style.backgroundImage = 'url("' + s[i].getAttribute("data-original") + '")', s[i].removeAttribute("data-original"))
                    }, 300, {});
                if (e.addEventListener("scroll", n), "createEvent" in document) {
                    var o = document.createEvent("HTMLEvents");
                    o.initEvent("scroll", !1, !0), e.dispatchEvent(o)
                } else e.fireEvent("onscroll")
            },
            initSlides: function(t) {
                t || (this.indicatorContainer = this.container.find(this.options.indicatorContainer), this.indicatorContainer.length && (this.indicatorPrototype = document.createElement("li"), this.indicators = this.indicatorContainer[0].children)), s.call(this, t)
            },
            addSlide: function(t) {
    ...
    function(t) {
        ...
        return t.extend(e.prototype, {
            ...
            videoFactory: function(e, i, s) {
                ...
                return v && (m.poster = v, n = this.imagePrototype.cloneNode(!1), t(n).addClass(d.toggleClass), n.src = v, n.draggable = !1, c.appendChild(n)), a = document.createElement("a"), a.setAttribute("target", "_blank"), s || a.setAttribute("download", g), a.href = y, m.src && (m.controls = !0, (s || t(m)).on("error", function() {
                    h.setTimeout(i, p)
                }).on("pause", function() {
    ...
    function(t) {
        ...
        return t.extend(s.prototype, {
            ...
            textFactory: function(t, e) {
                ...
                return o ? (void 0 === this.getItemProperty(t, n.urlProperty) && (t[n.urlProperty] = "//www.youtube.com/watch?v=" + o), void 0 === this.getItemProperty(t, n.videoPosterProperty) && (t[n.videoPosterProperty] = "//img.youtube.com/vi/" + o + "/maxresdefault.jpg"),
                    this.videoFactory(t, e, new s(o, n.youTubePlayerVars, n.youTubeClickToPlay))) : i.call(this, t, e)
            }
        }), e
    }),
    function(t) {
        ...
        t(document).on("click", "[data-gallery]", function(i) {
            var s = t(this).data("gallery"),
                ...
                a = {
                    ...
                    onslide: function() {
                        o.trigger("slide", arguments), document.querySelector(".indicator li.active").scrollIntoView()
                    },
                    onslideend: function() {
